...
import { FAKESHOP_ENDPOINT, FENDP_PRODUCTS, FENDP_LIST_CATEGORIES, FENDP_LIST_SPEC_CAT, PRODUCT_CATEGORIES } from '../constantExports/globalConstants'
...
function FakeshopAPIfetch() {
    ...
    //     return (
    //         (fakeshopData.map((element, index) => (
    //                    <p>element</p>   
    //                       ))
    //             )
    //         )
